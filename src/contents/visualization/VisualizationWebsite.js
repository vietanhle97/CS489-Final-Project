...
function VisualizationWebsite() {
  ...
  const categories = ["Perception change", "Future helpfulness",  "Data leak prevention", "Worried about site's data collection", "Worried that others know me too much", "Worried about easy-to-access private information", "Worried about data leakage", "Worried about unaware use of data", "Worried about unpermitted data sharing"];
